  ...
  return (
    <>
      ...
      <Section className="bg-background text-center">
        ...
        <div className="mt-8 bg-white p-8 rounded-lg shadow-xl inline-block border border-gray-200">
      ...
      <Section className="text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16 text-left">
          <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm hover:shadow-lg transition-shadow">
      ...
      <Section className="bg-background">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
              <div className="bg-white p-6 rounded-md shadow-sm border flex items-center"><span className="text-2xl font-bold text-primary mr-4">1.</span> <div><strong className="text-dark-blue">Diagnostic stratégique :</strong> Analyse complète du parcours, forces réelles vs illusions.</div></div>
              <div className="bg-white p-6 rounded-md shadow-sm border flex items-center"><span className="text-2xl font-bold text-primary mr-4">2.</span> <div><strong className="text-dark-blue">Positionnement professionnel :</strong> Rôle exact visé, secteurs compatibles, différenciation crédible.</div></div>
              <div className="bg-white p-6 rounded-md shadow-sm border flex items-center"><span className="text-2xl font-bold text-primary mr-4">3.</span> <div><strong className="text-dark-blue">Stratégie de certifications :</strong> CAPM / PMP / PRINCE2 : quoi, quand, pourquoi. Élimination de l'inutile.</div></div>
              <div className="bg-white p-6 rounded-md shadow-sm border flex items-center"><span className="text-2xl font-bold text-primary mr-4">4.</span> <div><strong className="text-dark-blue">Dossier professionnel Canada :</strong> CV canadien structuré et LinkedIn stratégique.</div></div>
              <div className="bg-white p-6 rounded-md shadow-sm border flex items-center"><span className="text-2xl font-bold text-primary mr-4">5.</span> <div><strong className="text-dark-blue">Plan d’accès au marché :</strong> Stratégie de candidature et networking ciblé.</div></div>
          </div>
      </Section>
      ...
      <Section className="text-center">
        ...
        <div className="grid md:grid-cols-2 gap-4 items-center max-w-5xl mx-auto bg-white p-4 rounded-xl shadow-lg border">
      ...
      {/* 7. TON RÔLE, NOTRE RÔLE */}
       <Section className="bg-background">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-lg max-w-4xl mx-auto">
      ...
      <Section>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
          <div className="border-2 border-gray-200 p-8 rounded-lg text-center flex flex-col justify-between">
            <div>
          ...
          <div className="border-4 border-primary p-8 rounded-lg text-center flex flex-col justify-between relative shadow-2xl">
      ...
      <Section className="bg-background">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8 text-center max-w-5xl mx-auto">
