...
import { FaCheckCircle, FaChartLine, FaTrophy, FaArrowRight, FaShieldAlt, FaStar } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ⭐ Transformation Accélérée sur 30 Jours
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-5 gap-8 mt-12">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-3xl border border-purple-500/20">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-3xl p-8 text-gray-900 shadow-2xl sticky top-32">
              <div className="flex justify-between items-center mb-8">
                ...
                <div className="text-right">
                  ...
                  <span className="text-sm font-bold text-gray-600 ml-1">FCFA</span>
                </div>
              </div>
              
              <form onSubmit={handlePayment} className="space-y-4">
                <div>
                  <label className="block text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Votre Nom</label>
                  <input 
                    type="text" 
                    required 
                    placeholder="Prénom et Nom"
                    className="w-full p-4 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none"
                ...
                >
                  {status === 'redirecting' ? 'Préparation...' : 'Lancer ma Transformation'}
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 flex items-center justify-center">
                ...
                <span className="text-[10px] text-gray-400 uppercase font-bold tracking-tighter">Paiement sécurisé crypté SSL via FedaPay</span>
              </div>
            </div>
          </div>
        </div>
